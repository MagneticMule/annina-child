    ...
    <div class="wrap">
        ...
        <div class="updated" style="background:#E9F7DF;clear: both;display: table;width: 100%;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;border-left: 4px solid #1fa67a;">
            ...
            <div class="anninaRight" style="float:right; width: 70%;">
                 ...
                 */
                ?>
                <tr valign="top"><th scope="row"><?php _e( 'Enter your WhatsApp URL', 'annina' ); ?></th>
                    <td>
                        <input id="annina_theme_options[whatsappurl]" class="regular-text" type="text" name="annina_theme_options[whatsappurl]" value="<?php if( isset( $se_options[ 'whatsappurl' ] ) ) echo esc_url( $se_options[ 'whatsappurl' ] ); ?>" />
                        <label class="description" for="annina_theme_options[whatsappurl]"><?php _e( 'Leave blank to hide WhatsApp Icon', 'annina' ); ?></label>
                    </td>
                </tr>
...
function annina_options_validate( $input ) {
    ...
    if( isset( $se_options[ 'whatsappurl' ] ) )
        $input['whatsappurl'] = esc_url_raw( $input['whatsappurl'] );
